        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mx-auto">
                    ...
                    else if(@$_GET['msg'] == 'passwordRequirement')
                    {
                        echo
                            '
                            <div class="alert alert-warning alert-dismissible fade show text-info text-center my-3">
								<button type="button" class="close" data-dismiss="alert">&times;</button>
								<strong>Password Check!</strong> Password must contain at least 1 number and 1 letter. Must contain any of these characters "!@#$%" and must be more than 8 characters.
				            </div>
                            ';
                    }
                    ...
                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                        ...
                        <div class="form-group">
                            <input type="password" id="trial" name="password" class="form-control" placeholder="Enter Password" required>
                        </div>
