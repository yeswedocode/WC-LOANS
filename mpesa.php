            ...
            <div class="row">
                <div class="col-md-6">
                    <ul class="nav nav-pills nav-fill">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active btn btn-outline-info" href="mpesa.php">MPESA</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    <table class="table table-striped" id="dataTable">
                        ...
                        <tbody>
                            <?php
                                   $selectQuery = "SELECT * FROM wallet WHERE type='MPESA'";
                    ...
                    <div class="d-flex flex-row-reverse bg-info text-light p-3 rounded-bottom">
                        <div class="py-1 px-5 text-right">
                            <div class="mb-2 fa-2x">Total Amount<sup>mpesa</sup><hr></div>
